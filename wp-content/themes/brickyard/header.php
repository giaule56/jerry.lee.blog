...
<?php if ($brickyard_options_db['brickyard_header_facebook_link'] != ''){ ?>
          <a class="social-icon facebook-icon" href="<?php echo esc_url($brickyard_options_db['brickyard_header_facebook_link']); ?>" target="_blank"></a>
<?php } ?>
<?php if ($brickyard_options_db['brickyard_header_twitter_link'] != ''){ ?>
          <a class="social-icon twitter-icon" href="<?php echo esc_url($brickyard_options_db['brickyard_header_twitter_link']); ?>" target="_blank"></a>
<?php } ?>
<?php if ($brickyard_options_db['brickyard_header_google_link'] != ''){ ?>
          <a class="social-icon google-icon" href="<?php echo esc_url($brickyard_options_db['brickyard_header_google_link']); ?>" target="_blank"></a>
<?php } ?>
<?php if ($brickyard_options_db['brickyard_header_rss_link'] != ''){ ?>
          <a class="social-icon rss-icon" href="<?php echo esc_url($brickyard_options_db['brickyard_header_rss_link']); ?>" target="_blank"></a>
<?php } ?>
        </div>
<?php } ?>
      </div>
